    ...
    <motion.div className="p-4 lg:p-8" variants={containerVariants} initial="hidden" animate="visible">
      ...
      <motion.div variants={itemVariants} className="mb-8 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-sm text-white hover:bg-primary/90 disabled:opacity-60"
        >
      ...
      {polling && (
        <motion.div
          ...
          className="mb-8 flex items-center gap-4 rounded-2xl border border-primary/20 bg-primary/5 px-6 py-5"
        >
          <Loader2 className="h-6 w-6 shrink-0 animate-spin text-primary" />
          <div>
            <p className="font-medium text-primary">AI가 포트폴리오를 분석 중입니다</p>
      ...
      {portfolio === null && !polling ? (
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center justify-center gap-6 rounded-2xl border border-dashed border-border py-24">
          ...
          <button
            onClick={handleRecommend}
            disabled={polling || recommending || !canRecommend}
            className="flex items-center gap-2 rounded-xl bg-primary px-6 py-3 text-sm text-white hover:bg-primary/90 disabled:opacity-60"
          >
            {recommending || polling
              ? <><Loader2 className="h-4 w-4 animate-spin" /> 분석 중...</>
            ...
            <motion.div variants={itemVariants} className="mb-8 space-y-3">
              ...
              {portfolio.summary && (
                <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6">
                  <p className="mb-2 text-sm font-medium text-primary">추천 요약</p>
